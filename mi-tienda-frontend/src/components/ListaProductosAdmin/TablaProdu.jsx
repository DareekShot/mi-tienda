...
function TablaProdu() {
  ...
  const handleAgregarProducto = () => {
    navigate("/admin/lista-productos/agregar-producto");
  };

  const handleEditarProducto = () => {
    navigate("/admin/lista-productos/editar-producto");
  };
              ...
              {orders.map((order, i) => (
                <tr key={i}>
                  ...
                  <td className="delivered">
                    <button className="edit-btn" title="Editar" onClick={handleEditarProducto}>✏️</button>
                    <button className="delete-btn" title="Eliminar">🗑️</button>
                  </td>
                </tr>
              ))}
            </tbody>
